...
export class AdminController {
  ...
  updateStudent(
    ...
    return this.adminService.updateStudent(
      Sid,
      Sidd,
      Sname,
      Sprogram,
  ...
  updateFaculty(
    ...
    return this.adminService.updateFaculty(
      Fid,
      Fidd,
      Fname,
      Fprogram,
  ...
  updateOfficer(
    ...
    return this.adminService.updateOfficer(
      Oid,
      Oidd,
      Oname,
      Odep,
  ...
  @UsePipes(new ValidationPipe())
  deleteStudentbyid(@Body('Sid', ParseIntPipe) Sid: number): any {
    return this.adminService.deleteStudentbyid(Sid);
  }

  // @Delete('/deleteStudent/:Sid')
  // deleteStudentbyid(@Param('Sid', ParseIntPipe) Sid: number): any {
  //   return this.adminService.deleteStudentbyid(Sid);
  // }

  @Delete('/deleteFaculty/')
  @UsePipes(new ValidationPipe())
  deleteFacultybyid(@Body('Fid', ParseIntPipe) Fid: number): any {
    return this.adminService.deleteFacultybyid(Fid);
  }
  @Delete('/deleteOfficer/')
  @UsePipes(new ValidationPipe())
  deleteOfficerbyid(@Body('Oid', ParseIntPipe) Oid: number): any {
    return this.adminService.deleteOfficerbyid(Oid);
  }
  @Delete('/deleteFacultysal/')
  @UsePipes(new ValidationPipe())
  deleteFacultysalbyid(@Body('Fid', ParseIntPipe) Fid: number): any {
    return this.adminService.deleteFacultysalbyid(Fid);
  }
  @Delete('/deleteOfficersal/')
  @UsePipes(new ValidationPipe())
  deleteOfficersalbyid(@Body('Osid', ParseIntPipe) Osid: number): any {
    return this.adminService.deleteOfficersalbyid(Osid);
  }
  @Delete('/deleteCourse/')
  @UsePipes(new ValidationPipe())
  deleteCoursebyid(@Body('Cid', ParseIntPipe) Cid: number): any {
    return this.adminService.deleteCoursebyid(Cid);
  }
  @Delete('/deleteNotice/')
  @UsePipes(new ValidationPipe())
  deleteNoticebyid(@Body('Nid', ParseIntPipe) Nid: number): any {
  ...
  @Delete('/deleteAdmin/')
  @UsePipes(new ValidationPipe())
  deleteAdminbyid(@Body('id', ParseIntPipe) id: number): any {
  ...
  async sendEmail(@Body() body) {
    ...
    // Create a transporter object with the Gmail account details
    const transporter = nodemailer.createTransport({
      service: 'gmail',
      auth: {
        user: 'srpubg7@gmail.com',
        pass: 'ubohnlzmhqpqmfjb',
      },
    });

    // Create an email message
    const message = {
      from: 'srpubg7@gmail.com',
      to,
      subject,
      text,
    };
