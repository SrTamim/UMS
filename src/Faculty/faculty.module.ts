...
import { AssignmentController } from './Controllers/assignemntcontroller.ontroller';
...
@Module({
  imports: [
    TypeOrmModule.forFeature([FacultyInfo, FacultyNotice, AssignmentInfo]),
  ],
  controllers: [
    FacultyController,
  ...
  providers: [FacultyService, NoticeService, AssignmentService],
})
